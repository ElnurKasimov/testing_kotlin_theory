package com.example.testingTheory.interfaceTest
...
class YourMovingObject(
    ...
    override fun move() {
//        val dx = (direction.x - currentCoordinates.x).toDouble()
//        val dy = (direction.y - currentCoordinates.y).toDouble()
//        val hyp = sqrt(dx.pow(2) + dy.pow(2))
//        currentCoordinates.x += (speed * (direction.x - currentCoordinates.x) / hyp).toInt()
//        currentCoordinates.y += (speed * (direction.y - currentCoordinates.y) / hyp).toInt()
